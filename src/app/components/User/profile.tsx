  ...
  return (
    <div className="min-h-screen bg-[#f6fafd] flex flex-col justify-start items-start">
      ...
      <div className="w-full py-4 px-4">
        <div className="text-[#08121e] text-2xl font-bold font-['Lato']">
          Perfil
        </div>
      </div>
      <div className="w-full px-5">
        ...
        <Link href="/profile">
          <div className="w-full py-4 border-b border-[#dddddd] flex items-center px-4">
            ...
            <div className="ml-1 text-[#08121e] text-base font-bold font-['Lato'] text-left flex-1">
        ...
        <div
          ...
          className="w-full py-4 border-b border-[#dddddd] flex items-center px-4 cursor-pointer"
        >
          <div className="w-6 h-6" />
          <svg
            xmlns="http://www.w3.org/2000/svg"
